...
class PersonasRoutes {
    ...
    config(): void {
        ...
        this.router.delete('/cliente/eliminar/:IdPersona', [mdAutenticacion.verificaToken,mdAutenticacion.verificaProfesionalAdmin], personasController.eliminarCliente);    // Actualiza
